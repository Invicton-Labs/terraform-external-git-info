output "is_git" {
  ...
  value       = nonsensitive(local.is_git_directory)
}
output "current_branch" {
  ...
  value       = nonsensitive(local.git_current_branch)
}
output "local_branches" {
  ...
  value       = nonsensitive(local.git_branches_local)
}
output "remote_branches" {
  ...
  value       = nonsensitive(local.git_branches_remote_by_origin)
}
output "commit_hash" {
  ...
  value       = nonsensitive(local.git_hash)
}
output "commit_hash_short" {
  ...
  value       = nonsensitive(local.git_hash_short)
}
output "current_tags" {
  ...
  value       = nonsensitive(local.git_current_tags)
}
output "tags" {
  ...
  value       = nonsensitive(local.git_tags)
}
output "remotes" {
  ...
  value       = nonsensitive(local.git_remotes)
}
